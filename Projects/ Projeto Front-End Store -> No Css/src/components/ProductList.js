...
class ProductList extends Component {
  ...
  AddProductToCart(product) {
    const { saveProductIntoShoppingCart, increaseQuantifyProductsInCart } = localStorageFunctions
    saveProductIntoShoppingCart(product);
    increaseQuantifyProductsInCart();
  }
  ...
  render() {
    const { products, search, cartCounter} = this.state;
